    ...
    while (letters_wrong != tries) and ("".join(clue) != word):
        ...
        if len(letter)==1 and letter.isalpha():
            if letters_tried.find(letter) != -1:
                print "Vous avez deja joue la lettre", letter
            else:
                ...
                if first_index == -1:
                    ...
                    print "Felicitations,",letter,"est correcte."
...
def guess_letter():
    print
    letter = raw_input("Devinez le mot mystere :")
    letter.strip()
    letter.lower()
    print
    return letter
...
def play_again():
    ...
    if answer in ("o", "O", "oui", "Oui", "Bien sur !"):
        ...
        print "Merci d'avoir joue. A tres bientot!"
